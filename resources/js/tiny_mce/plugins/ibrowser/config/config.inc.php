...
/*		array (
	...
	$cfg['ilibs'] = array (			
		array (																		
			'value'   	=> '/thebathroomsupply/resources/ibupload',												
			'text'    	=> 'Uploadded images',
		)	
	);
	...
	$cfg['ilibs_dir'] 	   = array('/thebathroomsupply/resources/ibupload');	
	...
	//$cfg['base_url'] 	= $cfg['root_dir']; 							// base url; e.g. 'http://localhost/'	 								// iBrowser main dir; e.g. '/home/domain/public_html/ibrowser/'	
