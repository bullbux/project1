...
//   UseCase3();
  ...
  function Usecase() {
      ...
      $merchant_id = "942230274288111";  // Your Merchant ID
      $merchant_key = "dEeMXLXVVgiCe1W39vJJvQ";  // Your Merchant Key
      $server_type = "sandbox";
      $currency = "USD";
      ...
      $cart->SetEditCartUrl("http://projects.illuminz.com/thebathroomsupply");
      
      // Specify "Return to xyz" link
      $cart->SetContinueShoppingUrl("http://projects.illuminz.com/thebathroomsupply");
