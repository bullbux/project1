...
class twitter {
    ...
    function twitter() {
        if(defined('TWITTER_USERNAME') && TWITTER_USERNAME && defined('TWITTER_PASSWORD') && TWITTER_PASSWORD) {
            $this->username = TWITTER_USERNAME;
            $this->password = TWITTER_PASSWORD;
        }else{
            die('Please set Username and Password of your Twitter Account.');
        }
    }
